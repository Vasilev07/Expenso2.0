...
export const editTransaction = createAction('[Transaction Edit] Edit Transaction', props<{ transaction: ITransaction, transactionId: string, currentTransactionId: string }>());
